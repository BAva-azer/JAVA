...
public class triplets{
    public static void main(String[]parameter){
       ...
       if(age1 == age2 && age3 == age2){
            System.out.println(n1 + ", " + n2 + " and " + n3 + " are triplets");
        }
        else if(age1 == age2 ){
            System.out.println(n1 + " and " + n2 + " are twins");
            
            if(age3 > age1) { System.out.println(n3 + " is the greatest"); }
        }    
        else if(age1 == age3){
            System.out.println(n1 + " and " + n3 + " are twins"); 
            if(age2 > age1) { System.out.println(n2 + " is the greatest"); }
        }    
        else if(age2 == age3){
            System.out.println(n2 + " and " + n3 + " are twins"); 
            if(age1 > age2) { System.out.println(n1 + " is the greatest"); }
        }
        else {
